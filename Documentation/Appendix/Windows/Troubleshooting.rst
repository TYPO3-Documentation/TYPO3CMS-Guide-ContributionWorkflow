...
Checklist:
	...
	2. Check if the private(!) SSH key is in the correct OpenSSH format. You can Export your SSH key to the correct OpenSSH format in the Putty Key Generator with Conversions -> Export OpenSSH Key -> safe with a filename, but without a file ending!
