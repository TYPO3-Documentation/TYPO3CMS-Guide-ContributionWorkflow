...
Once you have installed it, you can open up the Terminal app which is located
under Applications/Utilities on your mac. Once in the terminal,
type ``npm -v`` to get the version number of npm that is currently running on
your machine.
