...
..  sidebar:: The seven rules of a great Git commit message
    ...
    https://chris.beams.io/posts/git-commit/#seven-rules is an excellent guide
...
..  important::
    ...
    #.  The space after the colon (:) is mandatory. Otherwise the system will not
        properly update forge.

    #.  If you have multiple resolved or related issues, **use one line for each
...
#.  Add a `Resolves`-line for the ticket that is giving the reason for the
    revert.
